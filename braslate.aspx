<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="braslate.aspx.cs" Inherits="braslate" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><img src="images/lll.png" class="logo" alt=""></a>
                </div>
  ...
  <div class="title-all text-center">
                  <hr><h1>BRASLATE </h1><hr>
			</div>
       
    
    <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                                           ConnectionString="<%$ ConnectionStrings:jew %>" 
                                                SelectCommand="SELECT * FROM [product] where catnm='braslate' "  
                                            ProviderName="<%$ ConnectionStrings:jew.ProviderName %>"></asp:SqlDataSource>
						               <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource1" 
                                        DataKeyField="id" RepeatColumns="4" Height="700px" Width="1000px" CellPadding="10" align="center" OnSelectedIndexChanged="DataList1_SelectedIndexChanged">
                                     <ItemTemplate> 
