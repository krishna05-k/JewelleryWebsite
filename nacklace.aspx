<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="nacklace.aspx.cs" Inherits="nacklace" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <div class="title-all text-center">
                  <hr><h1>NACKLACE</h1><hr>
			</div>
       
    
    <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                                           ConnectionString="<%$ ConnectionStrings:jew %>" 
                                                SelectCommand="SELECT * FROM [product] where catnm='nackless' "  
